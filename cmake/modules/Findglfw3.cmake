...
if(EXISTS "${GLFW3_ROOT}")
    message(STATUS "Checking for directory
    ${GLFW3_ROOT}/src")
    # Check if the source code is hanging
    # out
    if(EXISTS "${GLFW3_ROOT}/src")
        add_subdirectory("${GLFW3_ROOT}"
            "${CMAKE_CURRENT_BINARY_DIR}/glfw")
        set(GLFW3_LOADED_AS_SUBDIRECTORY
            TRUE)
        message(STATUS
            "Loading
            GLFW3
